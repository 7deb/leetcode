...
<Container fluid className="p-0">
      ...
      <Row className="explore-section">
        <Col md={6}>
          <h2 className="explore-title">Start Exploring</h2>
        ...
        <Col md={6} className="explore-images-container cards">
          <img src="../images/c3.png" alt="Hero" className="explore-image cards-1"/>
          <img src="../images/c2.png" alt="Hero" className="explore-image cards-2"/>
          <img src="../images/c1.png" alt="Hero" className="explore-image cards-3"/>  
        </Col>
      </Row>
    </Container>
</div>
