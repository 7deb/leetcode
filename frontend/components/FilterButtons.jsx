      ...
      <div className="d-flex gap-2">
        ...
        <div className="d-flex min-w-300px flex-4 gap-2">
          <div className="flex-1 sentry-unmask">
            <div className="relative rounded-md input_input-container__SZzNg">
              ...
              <FormControl
                ...
                className="block w-full rounded-md leading-5 outline-none placeholder:text-label-4 dark:placeholder:text-dark-label-4 border-none py-1.5 text-label-2 dark:text-dark-label-2 bg-fill-3 dark:bg-dark-fill-3 focus:bg-fill-2 dark:focus:bg-dark-fill-2 pl-9 pr-3 sentry-unmask"
                value={searchQuery}
          ...
          <div className="relative" data-headlessui-state="">
            <Button
              aria-label="settings"
              className="flex items-center rounded px-3 py-1.5 text-left cursor-pointer focus:outline-none whitespace-nowrap leading-5 bg-fill-3 dark:bg-dark-fill-3 text-label-2 dark:text-dark-label-2 hover:bg-fill-2 dark:hover:bg-dark-fill-2"
